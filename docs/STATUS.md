...
- Repaired the waving pose as one continuous shoulder contour and moved the animation pivot from the shoulder to the rolled cuff, leaving only the forearm as a moving overlay.
